...
using Microsoft.VisualStudio.Services.PipelineCache.Client.WebApi;
...
{    
    ...
    public class PipelineArtifactServer
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            // Call the Pipleine Cache client to create an entry - currently there is no "client" , just make the HTTP call.
            //PipelineCacheHttpClient pb = new PipelineCacheHttpClient();
            //pb.CreatePipelineCacheArtifactAsync(fingerprint,branchScope,result.RootId.ValueString,result.ManifestId.ValueString);
            ...
            CancellationToken cancellationToken)
        {
            ...
            return this.DownloadPipelineCache(buildDropManager, res,targetDir,cancellationToken);
